...
RSpec.describe PollardRhoDecryptor do
  context '#decrypt' do
    ...
    context 'when public key has 2**8 key size' do
      it 'decrypt message' do
        logger = create_logger('pollard_rho_8.log')
        for i in 1..25 do
    ...
    context 'when public key has 2**9 key size' do
      it 'decrypt message' do
        logger = create_logger('pollard_rho_9.log')
        for i in 1..25 do
    ...
    context 'when public key has 2**10 key size' do
      it 'decrypt message' do
        logger = create_logger('pollard_rho_10.log')
        for i in 1..25 do
    ...
    context 'when public key has 2**11 key size' do
      it 'decrypt message' do
        logger = create_logger('pollard_rho_11.log')
        for i in 1..25 do
    ...
    context 'when public key has 2**12 key size' do
      it 'decrypt message' do
        logger = create_logger('pollard_rho_12.log')
        for i in 1..25 do
    ...
    context 'when public key has 2**13 key size' do
      it 'decrypt message' do
        logger = create_logger('pollard_rho_13.log')
        for i in 1..5 do
    ...
    context 'when public key has 2**14 key size' do
      it 'decrypt message' do
        logger = create_logger('pollard_rho_14.log')
        for i in 1..5 do
    ...
    context 'when public key has 2**15 key size' do
      it 'decrypt message' do
        logger = create_logger('pollard_rho_15.log')
        for i in 1..5 do
    ...
    def decrypt(logger, public_key)
      run_and_log(logger) { PollardRhoDecryptor.new(public_key).decrypt }
    end
  end
end
